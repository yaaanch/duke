...
public class Parser {
    public static Command parse(String input) throws DukeException {
        ...
        case "done":
            ...
            if (!currentInputArray[1].matches("-?\\d+")) {
                throw new MissingKeywordError(MissingKeywordError.Keyword.NUMBER);
            }
        ...
        case "deadline":
            ...
            if (deadlineArr.length < 2 || deadlineArr[0].length() < 10) {
                throw new InsufficientArgumentError();
            }
        ...
        case "event":
            ...
            if (!input.contains(" /at ")) {
                throw new MissingKeywordError(MissingKeywordError.Keyword.AT);
            }
            String[] eventArr = input.split(" /at ");
            if (eventArr.length < 2 || eventArr[0].length() < 7) {
                throw new InsufficientArgumentError();
            }
